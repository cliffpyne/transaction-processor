/* Elegansky screen loader — mirrors EleganskyBrain/src/components/common/screen-loader.tsx.
   Renders a pulsing Elegansky mark on page load, fades out 250ms after
   window.load fires. Fully removed from DOM 1.2s later so nothing else
...
(function () {
  ...
  s.textContent =
    '#elegansky-screen-loader{position:fixed;inset:0;z-index:2147483647;' +
